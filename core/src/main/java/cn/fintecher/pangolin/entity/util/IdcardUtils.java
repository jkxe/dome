...
public class IdcardUtils extends StringUtils {
    ...
    public static void main(String[] args) {
        System.err.println(validateCard("110101199901010117"));
    }
    ...
    public static Integer getAge(String idCard) {
        ...
        String nowYear = ZWDateUtil.fomratterDate(ZWDateUtil.getNowDate(), "yyyy");
    ...
    public static String getSex(String idCard) {
        int i;
        if (Objects.equals(idCard.length(), 15)) {
            String substring = idCard.substring(17, 18);
            i = Integer.parseInt(substring);
            if (Objects.equals(i % 2, 1)) {
                return "M";
            } else {
                return "F";
            }
