 ...
 */
@Component
@RabbitListener(queues = Constants.FOLLOWUP_OUTSOURCE_EXPORT_QE)
public class FollowupOutsourceProgressMessageReceiver {

    private final Logger logger = LoggerFactory.getLogger(FollowupOutsourceProgressMessageReceiver.class);
