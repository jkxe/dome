 ...
 */
public class UserProfessionalInfoPojo implements Serializable {

    /**  */
    private static final long serialVersionUID = 3515215823766653109L;
    //资源项ID
    ...
    //职业    
    private MetaProfession  profession;
    //职位
    ...
    public MetaProfession getProfession() {
        return profession;
    }

    public void setProfession(MetaProfession profession) {
    ...
    /**
     * Getter method for property <tt>companyAddress</tt>.
     * 
     * @return property value of companyAddress
     */
    ...
    /**
     * Setter method for property <tt>companyAddress</tt>.
     * 
     * @param companyAddress value to be assigned to property companyAddress
     */
