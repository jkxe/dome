...
public enum EnumActiveStatus {
    ...
    *            描述
    **/
    private EnumActiveStatus(String code, String description) {
        this.code = code;
    ...
    **/
    public static EnumActiveStatus find(String code) {
        for (EnumActiveStatus frs : EnumActiveStatus.values()) {
