...
import com.hsjry.user.facade.pojo.enums.EnumChildrenStatus;
...
public class UserPersonalBasicInfoPojo implements Serializable {

    /**  */
    private static final long  serialVersionUID = -6182830310667694744L;
    //客户ID
    ...
    //年龄
    private String             clientAgeNum;
    //婚姻状况
    private EnumMarriageStatus marriageStatus;
    //是否有子女
    private EnumChildrenStatus childrenStatus;
     ...
     */
    public void setClientAgeNum(String clientAgeNum) {
        this.clientAgeNum = clientAgeNum;
    }

    public EnumChildrenStatus getChildrenStatus() {
        return childrenStatus;
    }

    public void setChildrenStatus(EnumChildrenStatus childrenStatus) {
