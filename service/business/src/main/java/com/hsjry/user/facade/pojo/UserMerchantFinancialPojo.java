 ...
 * 
 * @author zhengqy15963
 * @version $Id: UserMerchantFinancialPojo.java, v 1.0 2018年5月8日 上午9:31:01 zhengqy15963 Exp $
 */
public class UserMerchantFinancialPojo implements Serializable {

    /**  */
    private static final long  serialVersionUID = 5507321214778689918L;
    //资源项ID
    ...
    //开户机构名称
    @NotNull(errorCode = "000001", message = "开户机构名称")
    @NotBlank(errorCode = "000001", message = "开户机构名称")
    private String             branchName;
    //户名
    @NotNull(errorCode = "000001", message = "户名")
    @NotBlank(errorCode = "000001", message = "户名")
