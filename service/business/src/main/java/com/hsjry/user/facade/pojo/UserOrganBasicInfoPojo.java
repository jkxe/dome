 ...
 * 
 * @author jiangjd12837
 * @version $Id: UserOrganBasicInfoPojo.java, v 1.0 2017年4月19日 下午4:22:40 jiangjd12837 Exp $
 */
public class UserOrganBasicInfoPojo implements Serializable {

    /**  */
    private static final long  serialVersionUID = -2730617481625755494L;
    /**内部请求报文*/
    private String             userId;
    //存续状态
    private EnumSurvivalStatus survivalStatus;
    //是否上市公司
    private EnumBool           marketProp;
    //上市地点
     ...
     */
    public void setMarketProp(EnumBool marketProp) {
