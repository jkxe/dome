 ...
 */
public class YrhfCollectionSignPojo implements Serializable {
    /**  */
    private static final long   serialVersionUID = 8016430289729812707L;
    /**
     * C 客户姓名
     */
    ...
    @NotBlank(errorCode = "000001", message = "扩展域")
    private String              extern_info;
     ...
     * Getter method for property <tt>mobileTel</tt>.
     *
     * @return property value of extern_info
     */
     ...
     * Setter method for property <tt>mobileTel</tt>.
     *
     * @param extern_info value to be assigned to property mobileTel
     */
