...
public class UserPersonalBasicInfoModifyPojo implements Serializable {

    /**  */
    private static final long  serialVersionUID = -137703359337745236L;
    //客户ID
    ...
    private EnumChildrenStatus hasChiledren;
    /**
    ...
    public EnumChildrenStatus getHasChiledren() {
        return hasChiledren;
    }

    public void setHasChiledren(EnumChildrenStatus hasChiledren) {
        this.hasChiledren = hasChiledren;
    }
}
