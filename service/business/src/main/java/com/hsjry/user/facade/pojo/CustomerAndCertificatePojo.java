 ...
 * 客户证件信息整合pojo
 * @author hongsj
 * @version $Id: CustomerAndCertificatePojo.java, v 1.0 2017年3月22日 上午10:02:16 hongsj Exp $
 */
public class CustomerAndCertificatePojo implements Serializable {
    /**  */
    private static final long             serialVersionUID = 4226752175350169158L;
    //客户ID
