 ...
 */
public class UserConsigneeInfoPojo implements Serializable {

    /**  */
    private static final long serialVersionUID = -5355088447855238759L;
    //收货人信息ID
    private String            consigneeInfoId;
    //收货人姓名
    @NotNull(errorCode = "000001", message = "收货人姓名")
    @NotBlank(errorCode = "000001", message = "收货人姓名")
    private String            consigneeName;
    //收货人电话
    @NotNull(errorCode = "000001", message = "收货人电话")
    @NotBlank(errorCode = "000001", message = "收货人电话")
