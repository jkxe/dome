 ...
 */
public class AddOrModifyManageOrganRequest implements Serializable {

    /**  */
    private static final long serialVersionUID = -7646438702256931418L;
     ...
     * 上级组织ID
     */
    @NotBlank(errorCode = "000001", message = "上级组织ID")
    @Length(errorCode = "000002", max = 32, message = "上级组织ID")
