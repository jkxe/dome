...
import com.hsjry.user.facade.pojo.UserLeaguerInfoPojo;
import com.hsjry.user.facade.pojo.UserLegalPersonalInfoPojo;
...
/**
 * 企业客户注册请求类，变更内容：法人信息需要手动输入
 * @author hongsj
 * @version $Id: RegisterCompanyManagePlatformRequest.java, v 1.0 2017年4月11日 上午9:52:40 hongsj Exp $
 */
public class RegisterCompanyManageInsertLegalRequest implements Serializable {
    /**  */
     ...
     * 法人客户信息
     */
    private UserLegalPersonalInfoPojo               userLegalPersonalInfoPojo;
    /**
     * 经营信息
     */
    ...
    /**
     * Getter method for property <tt>userLegalPersonalInfoPojo</tt>.
     * 
     * @return property value of userLegalPersonalInfoPojo
     */
    public UserLegalPersonalInfoPojo getUserLegalPersonalInfoPojo() {
        return userLegalPersonalInfoPojo;
    }

    /**
     * Setter method for property <tt>userLegalPersonalInfoPojo</tt>.
     * 
     * @param userLegalPersonalInfoPojo value to be assigned to property userLegalPersonalInfoPojo
     */
    public void setUserLegalPersonalInfoPojo(UserLegalPersonalInfoPojo userLegalPersonalInfoPojo) {
        this.userLegalPersonalInfoPojo = userLegalPersonalInfoPojo;
    }
