 ...
 * @Description:
 * @Package cn.fintecher.pangolin.dataimp.model
 * @ClassName: cn.fintecher.pangolin.dataimp.model.CaseInfo
 * @date 2018年07月03日 20:43
 */
@Data
public class CaseInfo implements Comparable<CaseInfo>{
    ...
    public int compareTo(CaseInfo o) {
        return this.accountBalance.compareTo(o.accountBalance);
    }
