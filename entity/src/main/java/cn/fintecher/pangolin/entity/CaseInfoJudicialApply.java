...
/**
 * @author yuanyanting
 * @version Id:CaseInfoVerificationModel.java,v 0.1 2017/9/27 15:52 yuanyanting Exp $$
 */
@Entity
@Table(name = "case_info_judicial_apply")
@Data
public class CaseInfoJudicialApply extends BaseEntity {
