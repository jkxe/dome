...
public class DataInfoExcelModel implements Serializable {
    ...
    @ExcelAnno(fieldType = ExcelAnno.FieldType.STRING)
    ...
    @ExcelAnno(fieldType = ExcelAnno.FieldType.DATE)
    @ApiModelProperty(notes = "贷款日期")
    @DateTimeFormat(pattern = "yyyy/MM/dd HH:mm:ss")
    private Date loanDate;

    @ExcelAnno(fieldType = ExcelAnno.FieldType.INTEGER)
    ...
    @ExcelAnno(fieldType = ExcelAnno.FieldType.DOUBLE)
